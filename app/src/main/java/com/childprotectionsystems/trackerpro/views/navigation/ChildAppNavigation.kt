...
import com.childprotectionsystems.trackerpro.views.Home.Child.SettingsChild
...
fun ChildAppNavigation() {
    ...
    var inboxBadgeCount by remember { mutableStateOf(5) } // Replace with live data if needed
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable("Inbox") { InboxChild(
                onMessagesRead = { inboxBadgeCount = 0 } // Reset badge count when messages read
            ) }
            composable("Settings") { SettingsChild() }
        }
    }
}